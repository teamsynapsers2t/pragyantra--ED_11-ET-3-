...
# Clean any existing root_flaw signals first so we can see if it gets generated
requests.delete(f"{SUPABASE_URL}/rest/v1/weakness_signals?user_id=eq.{TEST_USER_UUID}&signal=eq.root_flaw", headers=headers)

print("--- Calling fn_generate_weakness_report RPC ---")
...
print("\n--- Querying weakness_signals after report RPC call ---")
